...
AMM_PROGRAM_ID = Pubkey.from_string('675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8') #mainnet
#AMM_PROGRAM_ID = Pubkey.from_string('HWy1jotHpo6UqeQxx49dpYYdQB8wj9Qk9MdxwjLvDHB8') #devnet
...
def make_swap_instruction(amount_in: int, token_account_in: Pubkey.from_string, token_account_out: Pubkey.from_string,
        ...
        amm = AccountMeta(pubkey=accounts["amm_id"], is_signer=False, is_writable=True)
